...
function parsePokemonCSV(csvContent: string): Pokemon[] {
...
// Toxtricity Low Key Form was #00 on Serebii (typo), corrected to #197
const csvPath = join(process.cwd(), 'src/data/raw/Pokopia.csv');
const csvContent = readFileSync(csvPath, 'utf-8');

export const pokemon: Pokemon[] = parsePokemonCSV(csvContent);
